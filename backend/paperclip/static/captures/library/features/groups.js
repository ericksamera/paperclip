// services/server/paperclip/static/captures/library/features/groups.js
...
function loadInitialState(_group, key) {
...
export function initGroups() {
  ...
  document.addEventListener("click", (e) => {
    ...
    if (!group) return;
    const key =
      group.getAttribute("data-key") || `grp-${Math.random().toString(36).slice(2)}`;
