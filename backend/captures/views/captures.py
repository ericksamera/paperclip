...
from captures.references.xref_service import enrich_reference
from captures.services.exports import (
    csv_for_all_captures,
    bibtex_for_captures,
    ris_for_captures,
)
...
from .common import _author_list
...
def capture_enrich_refs(_request: HttpRequest, pk: str) -> HttpResponse:
    ...
    for r in refs_mgr.all():
        ...
        enriched = enrich_reference(r) or {}
        w.writerow(
            [
