...
def _no_debug_cursor(conn):
    """
    Keep this around for safety, but the key fix is: we no longer pass params
    to .execute() anywhere in this module. That avoids Django's % interpolation.
    """
