...
SCIENCEDIRECT_SNIPPET = (
    ...
    '    <div class="authors u-font-sans">A.T. Vincent, B. Boyle, N. Derome, '
    "S.J. Charette</div>\n"
    '    <div id="ref-id-sref4" class="title text-m">Improvement in the DNA '
    "sequencing of genomes "
    "bearing long repeated elements</div>\n"
    "  </div>\n"
    '  <div class="host u-font-sans">J&nbsp;Microbiol Methods, 107 (2014), pp. 186-188</div>\n'
    '  <div class="ReferenceLinks u-font-sans"><a '
    'href="/science/article/pii/S0167701214003066">'
    "View article</a></div>\n"
    "</span>\n"
)
...
class ScienceDirectParserTests(SimpleTestCase):
    def test_sciencedirect_core_fields(self) -> None:
        ...
        self.assertEqual(
            r["authors"], ["Vincent, A.T.", "Boyle, B.", "Derome, N.", "Charette, S.J."]
        )
