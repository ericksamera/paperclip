  ...
  <div class="separator"><div class="separator references-tab__collection">
    <ul class="rlist separator">
      <li data-bib-id="jfd12505-bib-0001">
        <span class="author">Attéré S.A.</span>, <span class="author">Vincent A.T.</span>, <span class="author">Trudel M.</span>,
        <span class="author">Chanut R.</span> &amp; <span class="author">Charette S.J.</span> (<span class="pubYear">2015</span>)
        <span class="articleTitle">Diversity and homogeneity among small plasmids of <i>Aeromonas salmonicida</i> subsp.
        <i>salmonicida</i> linked with geographical origin</span>. <i>Frontiers in Microbiology</i>
...
class WileyPaneParserTests(SimpleTestCase):
    def test_pane_pcw_references_extracts_core_fields(self):
