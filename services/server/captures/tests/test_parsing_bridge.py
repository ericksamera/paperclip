...
class HeadMetaTests(SimpleTestCase):
  def test_extract_head_meta_title_doi_year(self):
...
class RobustParseUnitTests(SimpleTestCase):
  def test_robust_parse_merges_keywords_and_journal_and_builds_preview(self):
    rv = robust_parse(url="https://example.org/foo", content_html=CONTENT_HTML, dom_html=DOM_WITH_META)
